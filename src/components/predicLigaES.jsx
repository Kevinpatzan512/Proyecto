  ...
  const partidos = [
    {
      id: "match1",
      local: "Jocoro",
      visitante: "Municipal Limeño",
      imgsrcl: "/img/ligamayor/jocoro.png",
      imgsrcv: "/img/ligamayor/municipal_lime.png",
    },
    {
      id: "match2",
      local: "Isidro Metapán",
      visitante: "Aguila",
      imgsrcl: "/img/ligamayor/isidro_metapan.png",
      imgsrcv: "/img/ligamayor/cdaguila.png",
    },
    {
      id: "match3",
      local: "Alianza",
      visitante: "Once Deportivo",
      imgsrcl: "/img/ligamayor/alianzafc.png",
      imgsrcv: "/img/ligamayor/oncedeportivo.png",
    },
    {
      id: "match4",
      local: "FAS",
      visitante: "Platense",
      imgsrcl: "/img/ligamayor/fas.png",
      imgsrcv: "/img/ligamayor/platense.png",
    },
    {
      id: "match5",
      local: "Dragón",
      visitante: "Firpo",
      imgsrcl: "/img/ligamayor/dragon.png",
      imgsrcv: "/img/ligamayor/la_firpo.png",
    },
    {
      id: "match6",
      local: "Santa Tecla",
      visitante: "Fuerte San Francisco",
      imgsrcl: "/img/ligamayor/santatecla.png",
      imgsrcv: "/img/ligamayor/fuerte.png",
    },
  ];

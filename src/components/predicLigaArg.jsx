  ...
  const partidos = [
    {
      ...
      local: "Arsenal",
      visitante: "Gimnasia",
      imgsrcl: "/img/primeradivision/arsenal.png",
      imgsrcv: "/img/primeradivision/gimnasia.png",
    },
    {
      id: "match2",
      local: "River Plate",
      visitante: "Huracán",
      imgsrcl: "/img/primeradivision/river.png",
      imgsrcv: "/img/primeradivision/huracan.png",
    },
    {
      id: "match3",
      local: "Argentinos Juniors",
      visitante: "Instituto",
      imgsrcl: "/img/primeradivision/argentinos.png",
      imgsrcv: "/img/primeradivision/instituto.png",
    },
    {
      id: "match4",
      local: "Atlético Tucumán",
      visitante: "Independiente",
      imgsrcl: "/img/primeradivision/atleticotucuman.png",
      imgsrcv: "/img/primeradivision/independiente.png",
    },
    {
      id: "match5",
      local: "Vélez Sarsfield",
      visitante: "Talleres",
      imgsrcl: "/img/primeradivision/velez.png",
      imgsrcv: "/img/primeradivision/talleres.png",
    },
    {
      id: "match6",
      local: "Unión",
      visitante: "Lanúes",
      imgsrcl: "/img/primeradivision/union.png",
      imgsrcv: "/img/primeradivision/lanus.png",
    },
    {
      id: "match7",
      local: "Racing Club",
      visitante: "Central Córdoba",
      imgsrcl: "/img/primeradivision/racing.png",
      imgsrcv: "/img/primeradivision/centralcordoba.png",
    },
    {
      id: "match8",
      local: "Estudiantes de la Plata",
      visitante: "Defensa y Justicia",
      imgsrcl: "/img/primeradivision/estudiantes.png",
      imgsrcv: "/img/primeradivision/defensa.png",
    },
    {
      id: "match9",
      local: "Newell's Old Boys",
      visitante: "Sarmiento",
      imgsrcl: "/img/primeradivision/newells.png",
      imgsrcv: "/img/primeradivision/sarmiento.png",
    },
    {
      id: "match10",
      local: "Godoy Cruz",
      visitante: "Platense",
      imgsrcl: "/img/primeradivision/godoycruz.png",
      imgsrcv: "/img/primeradivision/platense.png",
    },
    {
      id: "match11",
      local: "Barracas Central",
      visitante: "Rosario Central",
      imgsrcl: "/img/primeradivision/barracas.png",
      imgsrcv: "/img/primeradivision/rosariocentral.png",
    },
    {
      id: "match12",
      local: "Belgrano",
      visitante: "Tigre",
      imgsrcl: "/img/primeradivision/belgrano.png",
      imgsrcv: "/img/primeradivision/tigre.png",
    },
    {
      id: "match13",
      local: "Banfield",
      visitante: "Colon",
      imgsrcl: "/img/primeradivision/banfield.png",
      imgsrcv: "/img/primeradivision/colon.png",
    },
    {
      id: "match14",
      local: "San Lorenzo",
      visitante: "Boca Juniors",
      imgsrcl: "/img/primeradivision/sanlorenzo.png",
      imgsrcv: "/img/primeradivision/boca.png",
    },
  ];
